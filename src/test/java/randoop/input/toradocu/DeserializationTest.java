...
public class DeserializationTest {
  ...
  public void readTutorial() {
    ...
    String path = loader.getResource("toradocu-connection.json").getFile();
    File jsonFile = new File(path);
    ConditionCollection conditions = ToradocuConditionCollection.createToradocuConditions(jsonFile);
