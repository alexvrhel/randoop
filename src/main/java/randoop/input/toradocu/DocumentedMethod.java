...
public final class DocumentedMethod {
  ...
  public DocumentedMethod(
    ...
    this.paramTags = new LinkedHashSet<>(paramTags);
    this.isVarArgs = isVarArgs;
    this.throwsTags = new LinkedHashSet<>(throwsTags);
  ...
  public String toString() {
    ...
    if (returnType != null) {
      methodAsString.append(returnType).append(" ");
    }
    methodAsString.append(containingClass).append(Type.SEPARATOR).append(signature);
